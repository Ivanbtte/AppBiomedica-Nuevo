...
import { AdministradoresTrasladosService } from 'src/app/traslado-pacientes/core/administradores-traslados.service';
...
@Component({
  selector: 'app-administrar-usuarios-sub',
  templateUrl: './administrar-usuarios-sub.component.html',
  styleUrls: ['./administrar-usuarios-sub.component.css']
})
export class AdministrarUsuariosSubComponent implements OnInit {
  ...
  consultarAdministradores() {
    this.administradores.ConsultAdministradoresUnidad(this.user.PuestoOrganigrama.organigramaDelegacion.delegaciones.ClvDele, "64d51dd479b12822bc91a359ñ")
      .subscribe((result) => {
